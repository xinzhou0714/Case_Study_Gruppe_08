...
Fahrzeuge_OEM1_Typ11 <- read_delim("Data/Fahrzeug/Fahrzeuge_OEM1_Typ11.csv", ",")
...
```{r Fahrzeug_12_ammended, message = FALSE, warning = FALSE}

Fahrzeuge_OEM1_Typ12 <- read_csv2("Data/Fahrzeug/Fahrzeuge_OEM1_Typ12.csv")
...
```{r Fahrzeug_21_ammended, message = FALSE, warning = FALSE}

Fahrzeuge_OEM2_Typ21 <- read_delim("Data/Fahrzeug/Fahrzeuge_OEM2_Typ21.csv", ",")
...
```{r Fahrzeug_22_ammended, message = FALSE, warning = FALSE}

Fahrzeuge_OEM2_Typ22 <- read_csv2("Data/Fahrzeug/Fahrzeuge_OEM2_Typ22.csv")
...
```{r Motor_K1BE1_ammended, message = FALSE, warning = FALSE}

Komponente_K1BE1 <- read_delim("Data/Komponente/Komponente_K1BE1.csv", ",")
...
```{r Motor_K1BE2_ammended, message = FALSE, warning = FALSE}

Komponente_K1BE2 <- read_csv2("Data/Komponente/Komponente_K1BE2.csv")
...
```{r Motor_K1DI1_ammended, message = FALSE, warning = FALSE}

Komponente_K1DI1 <- read_delim("Data/Komponente/Komponente_K1DI1.csv", ",")
...
```{r Motor_K1DI2_1_ammended, message = FALSE, warning = FALSE}

Komponente_K1DI2 <- read_file("Data/Komponente/Komponente_K1DI2.txt") %>%
str_replace_all("\t","\n") %>%
str_replace_all("\\\\",",") %>%
read_delim(",")
# write_file(path ="Data/Komponente/Datei_K1DI2.csv")
# fread("Data/Komponente/Datei_K1DI2.txt",sep="\\")
...
```{r Motor_K1DI2_2_ammended, message = FALSE, warning = FALSE}
...
```{r Zulassungen_ammended, message = FALSE, warning = FALSE}
