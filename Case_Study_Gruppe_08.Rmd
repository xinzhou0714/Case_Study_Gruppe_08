...
```{r}
## Ich bin mir nicht sicher, ob dieser Teil notwendig ist. Ich habe die Filepaths direkt geschrieben, ohne Vektoren zu erstellen.  
```
...
```{r}
# Der folgende Code ist einfach einen Vorschlag für das einlesen 
```
# Einlesen der Daten 
