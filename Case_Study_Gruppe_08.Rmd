...
Anpassung_Datentyp <- function(datensatz, ID_Typ) {
  datensatz[[ID_Typ]] <- type.convert(datensatz[[ID_Typ]],as.is = T)
...
# Function für die mit Einzelteilen zusammenhängende Auswahl von relevanten Variablen und Anpassung des Datentyps von Variablen, die keine initiale Aufbereitung brauchen 
...
# Function für die mit Fahrzeugen zusammenhängende Auswahl von relevanten Variablen und Anpassung des Datentyps von Variablen, die keine initiale Aufbereitung brauchen 
...
# Function für die Anpassung des Datentyps von Variablen des Finalsatzes
...
# Union von separaten Variablen, die eigentlich die gleiche Information enthalten, sowie die Entfernung von unnötigen Zeichen innerhalb dieser Variabeln 
...
# Anwendung von die Datensätze aufbereitender Funktion für die Einzelteile (Details dieser Funktion liegen bei der Definition der Funktion vor)
...
Zuerst erstellen wir eine Dataframe, die alle die Identifikationsnummer der Motoren hat. Dann verbinden wir alle die Motoren mit ihren Bestandteilen. 

```{r Dataframe_alle_Motoren, message = FALSE, warning = FALSE}

# 1. Vertikale Verbindung von Dataframes der Komponente(Motoren)
# 2. Verbindung der Motoren mit ihren Bestandteilen 
# 3. Verbindung von Variablen, die die gleiche Information bezüglich eines Einzelteils enthalten
# 4. Verbindung von Einzelteilen mit ihren Fehlermeldung, Produktionsdaten und Fehlerdaten 
