...
```{r EchteApp, message = FALSE, warning = FALSE}
...
Dieselmotoren") + theme_minimal() + theme(text = element_text(family = "Bookman"), title = element_text(color = "gray25"), plot.background = element_rect(fill = "gray95"), plot.margin = unit(c(5, 10, 5, 10), units = "mm"))
  })
...
# Erstellen der Reactive Endpoint für den Fahrzeugtyp (Zweite Aufgabe der Visualisierung - Lebensdauer der Fahrzeuge)  
  ...
  Fehlerdatum (Tage)", title = "Lebensdauer der Fahrzeuge von Typ 11") + theme_minimal() + theme(text = element_text(family = "Bookman"), title = element_text(color = "gray25"), plot.background = element_rect(fill = "gray95"), plot.margin = unit(c(5, 10, 5, 10), units = "mm"), axis.title.y = element_text(margin(t = 0, r = 40, b = 0, l = 0)), axis.title.x = element_text(margin(t = 40, r = 0, b = 0, l = 0)) )
   }
    else{ggplot()}
  })
   ...
   output$Boxplot_Fahreugtyp_12 <- plotly::renderPlotly({
    ...
    ggplot(Data_frame_Boxplot_Fahrzeugtyp_12(), aes(x = Motor_Typ, y = Lebensdauer_in_Days)) + coord_flip() + geom_boxplot(fill = "DarkRed") + labs(x ="Motorentyp", y ="Zeitintervall zwischen Zulassung und 
  Fehlerdatum (Tage)", title = "Lebensdauer der Fahrzeuge von Typ 12") + theme_minimal() + theme(text = element_text(family = "Bookman"), title = element_text(color = "gray25"), plot.background = element_rect(fill = "gray95"), plot.margin = unit(c(5, 10, 5, 10), units = "mm"))
    }
     else{ggplot()}
  })
   ...
   output$Boxplot_Fahreugtyp_21 <- plotly::renderPlotly({
    ...
    ggplot(Data_frame_Boxplot_Fahrzeugtyp_21(), aes(x = Motor_Typ, y = Lebensdauer_in_Days)) + coord_flip() + geom_boxplot(fill = "DarkRed", outlier.colour = "red", outlier.shape = 1) + labs(x ="Motorentyp", y ="Zeitintervall zwischen Zulassung und 
  Fehlerdatum (Tage)", title = "Lebensdauer der Fahrzeuge von Typ 21") + theme_minimal() + theme(text = element_text(family = "Bookman"), title = element_text(color = "gray25"), plot.background = element_rect(fill = "gray95"), plot.margin = unit(c(5, 10, 5, 10), units = "mm"))
    }
     else{ggplot()}
  })
   ...
   output$Boxplot_Fahreugtyp_22 <- plotly::renderPlotly({
    ...
    ggplot(Data_frame_Boxplot_Fahrzeugtyp_22(), aes(x = Motor_Typ, y = Lebensdauer_in_Days)) + coord_flip() + geom_boxplot(fill = "DarkRed", outlier.colour = "white", outlier.shape = NA) + labs(x ="Motorentyp", y ="Zeitintervall zwischen Zulassung und 
  Fehlerdatum (Tage)", title = "Lebensdauer der Fahrzeuge von Typ 22") + theme_minimal() + theme(text = element_text(family = "Bookman"), title = element_text(color = "gray25"), plot.background = element_rect(fill = "gray95"), plot.margin = unit(c(5, 10, 5, 10), units = "mm"))
    }
     else{ggplot()}
  })
